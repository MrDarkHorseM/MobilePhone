...
public class JmsConfig {
    ...
    public SQSConnectionFactory getSQSConnectionFactory(){
        AmazonSQS amazonSQSClient = AmazonSQSClientBuilder.standard().withRegion("us-east-2").withCredentials(new DefaultAWSCredentialsProviderChain()).build();
    ...
    public DefaultJmsListenerContainerFactory getDefaultJmsListnerContainerFactory(@Autowired SQSConnectionFactory connectionFactory, @Autowired DynamicDestinationResolver dynamicDestinationResolver){
